	...
	<form action="<%=request.getContextPath()%>/order/insert" method="post">
		...
		<select class="form-control mb-3" name="or_request" id="or_request">
 		...
 		<div class="clearfix mb-3">
			...
			<div class="float-right" style="width:calc(100% - 250px - 100px)">
				<div class="form-group">
				...
				<div class="form-group">
				  <input type="text" class="form-control" id="od_amount" name="od_amount" value="${amount}" readonly>
				</div>
 			</div>
		</div>
 		<div class="clearfix"><h3>결제정보</h3>
	 		<table class="table">
	 			<tr>
	 				<th>주문상품</th>
	 	...
	 	<div class="clearfix"><h3>결제수단</h3>
		    ...
		    <li class="nav-item">
	 		...
	 		<table class="table">
	 			<tr>
	 				<th>입금은행</th>
	 				<td>국민은행 : 80910104188193 (주)라이킷 크리에이티브</td>
	 			</tr>
	 			<tr>
	 				<th>입금자명</th>
	 				<td>
	 					<input class="form-control col-6" type="text" id="od_pname" style="height:30px;">
	 				</td>
	 			</tr>
	 		</table> 		
 		</div>
 		<div class="clearfix">
 			<div class="agreement">
 				...
 				<label for="agreement">
 					<strong>[필수] 구매조건 확인 및 결제진행 동의</strong>
 				</label>
 			</div>
 		</div>
