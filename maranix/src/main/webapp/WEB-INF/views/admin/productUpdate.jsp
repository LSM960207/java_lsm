...
<form class="container" enctype="multipart/form-data" method="post" action="<c:url value="/admin/product/update"></c:url>">
	...
	<div class="clearfix">
		...
		<div class="float-right" style="width:calc(100% - 150px - 10px)">
			...
			<div class="form-group">
			  <input type="text" class="form-control" readonly name="pr_code" value="${pr.pr_code}">
			</div>
			<div class="form-group">
	...
	<div class="form-group">
	  <textarea class="form-control" name="pr_content" placeholder="제품 상세">${pr.pr_content}</textarea>
	</div>
	<div class="form-group">
