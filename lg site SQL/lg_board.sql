...
CREATE TABLE `board` (
  ...
  `bd_scret` enum('0','1') NOT NULL DEFAULT '0',
  ...
  CONSTRAINT `FK_product_TO_board_1` FOREIGN KEY (`bd_pr_code`) REFERENCES `product` (`pr_code`)
...
-- Dump completed on 2022-09-01 17:03:30
