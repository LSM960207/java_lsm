...
public class AccountBookManager implements ConsoleProgram{
	...
	private final int exitMenu = 5;	//프로그램종료
	...
	public boolean modifyAccountBook() {
		...
		System.out.println("=====================");
		System.out.println("선택한 항목은 위 내역입니다. 수정하시겠습니까? [예:true / 아니오:false");
		...
		System.out.print("결제방식을 수정하겠습니까?[예:true/아니오:false] : ");
		ok = scan.nextBoolean();
	...
	public Item deleteAccountBook() {
		...
		if(tmp != null) {
			...
			System.out.println("=====================");
			System.out.println("선택한 항목은 위 내역입니다. 삭제하시겠습니까? [예:true / 아니오:false");
			boolean ok = scan.nextBoolean();
			if(!ok) {
				return null;
			}
