...
public class Ex08_List_Test2 {
	...
	public static void main(String[] args) {
		...
		/* - Student 클래스에 equals를 오버라이딩 하지않으면 indexOf, contains, remove 메소드가 원하는대로 동작하지않음 */
		System.out.println(list);
		int index = list.indexOf(new Student(1, 1, 1, "홍길동"));
		System.out.println("list에 학생 정보가 있습니까? " + index + "번지");
		System.out.println("list에 학생 정보가 있습니까? " + list.contains(new Student(1, 1, 1, "홍길동")));
