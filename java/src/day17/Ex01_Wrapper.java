...
public class Ex01_Wrapper {
	...
	public static void main(String[] args) {
		 ...
		 *   그래서 기본 타입으로 만든 Wrapper 클래스를 이용해야한다.
		 * - Wrapper클래스와 기본 타입의 차이
		 *    - Wrapper클래스의 객체는 기본 타입값과 null을 가짐
		 *     => 언박싱할 때 조심해야함. null일 수도 있기 때문에
		...
		Integer num3 = null;
		//int num4 = num3;	//예외 발생. null을 기본 타입으로 바꿀 수 없음
		int num5 = 1, num6 = 1;
		System.out.print("두 기본 타입변수 ==로 비교		 : ");
		if(num5 == num6) {
		...
		System.out.print("Wrapper 객체와 기본 타입 ==로 비교	 : ");
		if(num7 == (int)num8) {
			System.out.println(num7 + "와 " + num8 + "은 같다");
		}else {
			System.out.println(num7 + "와 " + num8 + "은 다르다");
		...
		System.out.println("문자열 : " + str2 + ", 실수 : " + num9);
	}
