...
public class Ex4_Casting {
	...
	public static void main(String[] args) {
		...
		// 자동 타입변환의 예
		byte num1_1 = 1;
		int num1_2 = num1_1; // byte(작은 값)를 int(큰 값)에
		double num1_3 = num1_2; // int(작은 값)를 double(큰 값)에
		
		// 강제 타입변환의 예
		int num2_1 = 1;
		byte num2_2 = (byte)num2_1; // 이렇게
		num2_1 = (int)1.23;
		...
		// 55~56페이지. 정수를 실수로 자동타입변환할 때 정밀도가 떨어질 수 있다 int -> float
		// 이를 피하기 위해서는 int -> float으로 타입변환하기보다 double로 타입변환하여 활용한다
		int num5_1 = 1234567890;
		float num5_2 = num5_1; // 자동 타입변환 // 실수는 왠만하면 double로 변환
