...
public class Ex02_ScoreMain {
	...
	public static void main(String[] args) {
		 ...
		 * 1. 성적 추가
		 * 	- 과목명, 중간성적, 기말성적, 수행평가 성적을 입력한다
		 *  - 과목명은 국어와 같은 문자열
		 *  - 기말, 중간, 수행평가는 0~100사이의 정수
		 *  - 학년은 1~3 사이의 정수, 학기는 1~2 사이의 정수
		 *  - 입력된 성적 정보가 이미 있으면 추가하지 않고 없으면 입력된 성적 정보를 성적리스트에 추가한다
		 *  - 입력된 성적 정보가 있는지 여부는 학년, 학기, 과목이 같으면 있다고 판별한다
		 * 2. 성적 확인
		 *  - 서브 메뉴를 이용하여 다양한 방식으로 성적을 확인
		 *  - 서브 메뉴는 1. 모든 성적, 2. 학기 성적, 3. 과목 성적
