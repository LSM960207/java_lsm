...
-- green2 데이터베이스를 생성하세요.
create database if not exists green2;
-- 생성된 grren2 데이터베이스를 선택하세요.
-- 방법1 : 쿼리문 입력
use green2;
-- 방법2 : 데이터베이스를 더블 클릭
...
-- 컴퓨터공학부 학부위치가 그린대학교 2관 101호로 이동을 하는 경우 알맞은 쿼리문을 작성하세요
