...
public class MemberServiceImp implements MemberService {
	...
	public boolean findPw(MemberVO member) {
		...
		//임시 비밀번호 발급 - 랜덤으로 8자리(영문 대문자 소문자와 숫자만 가능) (26,26,10)
		String newPw = "";
		int max = 8;
		for(int i = 0; i < max; i++) {
		...
		for(int i = 0; i < max; i++) {
			int r = (int)(Math.random()*62);
			newPw += characters.charAt(r);
		}
		*/
		//System.out.println(newPw); => 콘솔에 찍어보기
